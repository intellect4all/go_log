...
import (
	...
	"go_log/internal/discovery"
	"go_log/internal/log"
	"go_log/internal/server"
...
func (a *Agent) setupServer() error {
	authorizer, _ := auth.New(a.Config.ACLModelFile, a.Config.ACLPolicyFile)
...
func (a *Agent) setupMux() error {
	rpcAddr := fmt.Sprintf(":%d", a.Config.RCPPort)
